...
def outputplanets():
    ...
    for catalogue in catalogues:
            ...
            for planet in root.findall(".//planet"):
                ...
                if key is not None:
                    ...
                    if planetid.replace("Gliese", "GJ") in aliases:
                        ...
                        outputstr += "\n" + "%s contains \033[91m%s\033[0m which is different than  \033[91m%s\033[0m in OEC." %( catalogue,planetid, key)
                        ...
                        outputstr += "\n" + "%s contains \033[1m%s\033[0m which is not in OEC." %( catalogue,planetid)
                    if key is not None:
        ...
        outputstr += "\n" + "OEC contains \033[1m%d\033[0m planets which are not in %s." %(len(notaccountedfor),catalogue)
        outputstr += "\n" + "OEC contains \033[91m%d\033[0m planets which are differently named than in %s." %(len(differentlynamed),catalogue)
        return outputstr


def outputplanets_html():
    outputstr = ""
    #catalogues = ["exoplaneteu"]
    catalogues = ["exoplaneteu", "exoplanetarchive"]
    for catalogue in catalogues:
        ...
        for filename in glob.glob("systems_"+catalogue+"/*.xml"):
            ...
            for planet in root.findall(".//planet"):
                ...
                if key is not None:
                    ...
                    if planetid.replace("Gliese", "GJ") in aliases:
                        key = planetid.replace("Gliese", "GJ") 
                        outputstr += "\n" + "%s contains <b>%s</b> which is different than <b>%s</b> in OEC." %( catalogue,planetid, key)
                    elif planetid.replace("GJ", "Gliese") in aliases:
                        key = planetid.replace("GJ", "Gliese") 
                        outputstr += "\n" + "%s contains <b>%s</b> which is different than  <b>%s</b> in OEC." %( catalogue,planetid, key)
                    elif planetid.replace("Gj", "Gliese") in aliases:
                        ...
                        outputstr += "\n" + "%s contains <b>%s</b> which is not in OEC." %( catalogue,planetid)
                    if key is not None:
                        uniquelist_cat[aliases[key]] = 2
        ...
        outputstr += "\n" + "OEC contains <b>%s</b> planets which are not in %s." %(len(notaccountedfor),catalogue)
        outputstr += "\n" + "OEC contains <b>%s</b> planets which are differently named than in %s." %(len(differentlynamed),catalogue)
    return outputstr
